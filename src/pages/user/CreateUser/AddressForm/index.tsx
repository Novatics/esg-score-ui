...
const AddressForm = ({ fadeOut, setFadeOut }: TAddressFormProps) => {
  ...
  return (
    <Box width="100%" maxWidth={isSmallScreen ? 304 : 550}>
      ...
      <AnimatedContainer fadeOut={fadeOut} setFadeOut={setFadeOut} delay={750}>
        <InputField
      ...
      <AnimatedContainer fadeOut={fadeOut} setFadeOut={setFadeOut} delay={1000}>
        <InputField
          sx={{ width: isSmallScreen ? 304 : 400 }}
          size="small"
      ...
      <AnimatedContainer fadeOut={fadeOut} setFadeOut={setFadeOut} delay={1250}>
