...
export const companyThreats = {
  // eslint-disable-next-line prettier/prettier
  'User\'s name leaked': {
    title: 'Name leaked',
    strengthTitle: 'Name',
    recommendedAction:
      'Alert these users to check their personal report and verify if name is online without their consent. They may need some takedown or removal services.',
    description: 'occurrences were discovered in your company’s user reports.',

    strengthAreaText: 'None of your company users have a compromised email account',
    reasonToBeImportant:
  ...
  'Address leaked': {
    title: 'Addresses Leaked',
    strengthTitle: 'Address',
    recommendedAction:
      'Alert these users to check their personal report and verify if their address is online without their consent. They may need some takedown or removal services.',
    description: 'occurrences were discovered in your company’s user reports.',

    strengthAreaText: 'None of your company users have their address leaked',
    reasonToBeImportant:
  ...
  'Phone Numbers Leaked': {
    title: 'Phone Numbers Leaked',
    strengthTitle: 'Phone Numbers',
    recommendedAction:
      'Alert these users to check their personal report and verify if their phone number is online without their consent. They may need some takedown or removal services.',
    description: 'occurrences were discovered in your company’s user reports.',
    reasonToBeImportant:
    ...
    strengthAreaText: 'None of your company users have their phone number leaked',
    icon: PhoneNumberSVG,
  },
  'Password leaked': {
    title: 'Password Leaked',
    strengthTitle: 'Passwords',
    recommendedAction:
      'Alert these users to check their personal report and verify if their phone number is online without their consent. They may need some takedown or removal services.',
    description: 'occurrences were discovered in your company’s user reports.',
    reasonToBeImportant:
  ...
  'Web Domains leaked': {
    ...
    recommendedAction:
      'Alert these users to check their personal report and verify if their domain was compromised. They may need to contact their provider.',
    description: 'company users have a web domain compromised',
    reasonToBeImportant:
    ...
    strengthAreaText: 'None of your company users have a web domain compromised',
    icon: WebDomainsSVG,
  },
  'Personal Image in Use': {
    ...
    recommendedAction:
      'Alert these users to check their personal report and verify if their personal image is online without their consent. They may need some takedown or removal services.',
    description: 'occurrences were discovered in your company’s user reports.',
    reasonToBeImportant:
    ...
    strengthAreaText: 'None of your company users have their image being used online',
    icon: PersonalImgSVG,
  },
  'Two Factor Authentication': {
    ...
    recommendedAction:
      'Alert these users to check their personal report, log into their respective accounts at risk and get that extra layer of protection.',
    description: 'company users do not use Two Factor Authentication',
    reasonToBeImportant:
    ...
    strengthAreaText: 'All of your company members use Two Factor Authentication',
    icon: TwoFaSVG,
  },
  'Cybersecurity Response Plan': {
    ...
    description: 'company users don’t have a Cybersecurity Response Plan',
    reasonToBeImportant:
    ...
    strengthAreaText: 'All of your company users have a Cybersecurity Response Plan',
  ...
  'Use top 10 apps': {
    ...
    recommendedAction:
      'Alert these users to check their personal report, remove apps that they don’t use often and review permissions on other apps.',
    description: 'company members use apps that could put them in danger',
    reasonToBeImportant:
    ...
    strengthAreaText: 'None of your company members use apps that could put them in danger',
  ...
  'Private Social Media': {
    ...
    recommendedAction:
      'Alert these users to check their personal report, go to settings in their social media accounts and set them to private.',
    description: 'company users don’t have all their social accounts set to private',
    reasonToBeImportant:
    ...
    strengthAreaText: 'All company users have all their social accounts set to private.',
  ...
  'Password Manager': {
    ...
    recommendedAction:
      'Alert these users to check their personal report and acquire a Password Manager from the Referrals page to protect their passwords.',
    description: 'company users do not use a Passoword Manager',
    reasonToBeImportant:
    ...
    strengthAreaText: 'All of your company members use a Password Manager',
